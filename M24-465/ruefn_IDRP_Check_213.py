"""
Rule Name: ruefn_IDRP_Check_213
Domains: QS_V
QSTESTCD = PIJ0103 and QSORRES = Null. Query should fire
"""

def ruefn_IDRP_Check_213(query_text, QS_V):
    payload_records = []
    prim_df = QS_V.copy()
    if prim_df.shape[0] > 0:
        args_dict = {
			...
			'logic_text': "((QSTESTCD.str.upper() == 'PIJ0103')and (QSORRES in @null_values))"
        }
