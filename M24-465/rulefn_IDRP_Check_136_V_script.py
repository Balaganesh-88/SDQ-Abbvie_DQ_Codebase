"""
Rule Name: rulefn_IDRP_Check_136
Domains: ho_f_df
logic: HOOCCUR <> null and _V_SSAEFH = null. Query should fire.
"""

def rulefn_IDRP_Check_136(query_text, ho_f_df):
    payload_records = []
    prim_df = ho_f_df
    if prim_df.shape[0] > 0:
        args_dict = {
            ...
            'p_visit_ls': [],
            'logic_text': " (HOOCCUR is not @null_values)and (_V_SSAEFH.isna() or _V_SSAEFH in @null_values)",
